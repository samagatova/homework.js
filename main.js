...
let number = 10; // Пример числового значения
...
if (person1.age >17){
  console.log(`Привет, меня зовут ${person1.name} и это мой первый код`);
} else {
  console.log(`Привет, меня зовут ${person1.name} и я несовершеннолетний`);
}
...
let lang1 = 'ru';
let message1 = lang1 === 'en' ? 'This is English' :
    lang1 === 'ru' ? 'Это русский' :
    lang1 === 'de' ? 'Das ist Deutsch' :
    lang1 === 'kg' ? 'Бул кыргыз тили' :
    '';
...
let name3 = "Leila";
let age3 = 16;
if (typeof name3 === "string" && typeof age3 === "number") {
  console.log("Все введено верно");
} else {
